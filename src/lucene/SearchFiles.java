...
public class SearchFiles {
	 ...
	 *
	 * When the query is executed for the first time, then only enough results to
	 * fill 5 result pages. If the user wants to page beyond this limit, the is
	 * executed another time and all hits are collected.
	 *
	 */
